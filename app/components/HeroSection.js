        ...
        <div className='bg-black  relative h-[100vh]  overflow-hidden w-[100vw]'>
            ...
            <div className={` bg-green-900/50  overflow-hidden backdrop-blur-sm h-[90%] mx-auto  rounded-lg z-20 w-full  flex flex-col gap-2 items-center absolute    right-0 py-2 justify-end   transition-all delay-100 ${toggle ? 'top-[4.5rem]' : 'top-[-1000rem]'}     `}>
                ...
                <ul className=' m-auto w-ful gap-6 h-full flex justify-center items-center flex-col'>
                    ...
                    <li className=' hidden md:block'><button onClick={signInWithGoogleAsFarmer} className=' text-[12px] rounded-lg gap-2 px-4 mx-auto text-center flex items-center  py-2 bg-white'> <BsGoogle /> SignIn with Google</button></li>
                    <li className=' block md:hidden'><button className=' text-[12px] rounded-lg gap-2 px-4 mx-auto text-center flex items-center  py-2 bg-white'>Not Available On Mobile Switch To Desktop</button></li>
                </ul>
            </div>
